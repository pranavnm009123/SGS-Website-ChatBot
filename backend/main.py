...
async def read_careers():
    return FileResponse(os.path.join(FRONTEND_DIR, "careers.html"))
...
async def read_testimonials():
    return FileResponse(os.path.join(FRONTEND_DIR, "testimonials.html"))

@app.get("/software-engineering")
async def read_software_engineering():
    return FileResponse(os.path.join(FRONTEND_DIR, "software-engineering.html"))

@app.get("/cloud-services")
async def read_cloud_services():
    return FileResponse(os.path.join(FRONTEND_DIR, "cloud-services.html"))

@app.get("/cyber-security")
async def read_cyber_security():
    return FileResponse(os.path.join(FRONTEND_DIR, "cyber-security.html"))

@app.get("/data-engineering")
async def read_data_engineering():
    return FileResponse(os.path.join(FRONTEND_DIR, "data-engineering.html"))
...
async def upload_pdf(request: Request, file: UploadFile = File(...)):
    ...
    validate_file(file.filename, file.content_type, file_size, content)
